...
<head>
    ...
    <style>
        ...
        .top-menu-item {
            color:white !important; font-size: 15px ; font-weight: bold;
            border-bottom: 1px white solid; text-decoration:none !important;
        }
...
<div id="app-page" @mouseup="dragStop($event)">
    ...
    <!---- ОСНОВНОЙ КОНТЕНТ -->
    <section id="about" class="about section-space-padding" style="border:0px red solid;">

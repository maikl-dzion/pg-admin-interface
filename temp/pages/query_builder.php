<div class="container" style="border:0px gainsboro solid" >
    ...
    <div class="row" >
        <div class="col-sm-6" style="padding: 0px;"><h4 style="font-weight: bold; margin:0px; font-style:italic;">SqlQuery page</h4></div>
    </div> <hr>
    ...
    <div class="row" >
        <div class="col-sm-5 commonButtonsPanel" >
            <button @click="commonAction('users', $event)"          class="btn customBtn b1" >Пользователи</button>
            <button @click="commonAction('tables', $event)"         class="btn customBtn b1" >Таблицы</button>
            <button @click="commonAction('databases', $event)"      class="btn customBtn b1" >Базы</button>
            <button @click="commonAction('form-edit-com', $event)"  class="btn customBtn b1" >Форма</button>
            <button @click="sqlCommandRun('get_roles')"     class="btn customBtn b1" >Роли</button>
        </div>
        ...
        <div class="col-md-7 commonRightPanel" >
            ...
            <template v-else-if="commonActionName == 'tables'" >
                <div v-for="(item, fname) in commonItem" >
                    ...
                    <template v-if="commonItem[fname]['auto_increment'] || commonItem[fname]['column_default']">
